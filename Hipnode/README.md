...
Build a Fullstack Social Networking Application

Check out the complete project requirements [here](https://drive.google.com/file/d/1YUafKvb65P0QnN9M-XAVrYaX52rrzQ5r/view?usp=sharing)
...
1. Clone the repo
   ...
   ```shell
    git clone https://github.com/JavaScript-Mastery-PRO/Cohort3_Team2_HipNode.git
   ```

2. Change directory to the project directory

   ```shell
   cd Cohort3_Team2_HipNode
   ```
